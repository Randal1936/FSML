...
class institutions_re:
    ...
    def __init__(self, Data, userdict, indifile, indisheet, stopwords):
        ...
        self.DTM_aver = dtm_aver_class  # DTM 1、2、3 被监管机构数求均值
        self.DTM_final = dtm_final  # DTM 1、2、3 被监管业务机构数汇总
...
class institutions_jieba:
    ...
    def __init__(self, Data, userdict, indifile, indisheet, stopwords):
        ...
        print("开始检索正文……")
        df = self.df.copy()  # 防止对函数以外的样本框造成影响
